...
namespace ClubMembership.DAL
{
    public class MembershipInitializer : System.Data.Entity.DropCreateDatabaseAlways<MembershipContext> //TODO: change to model drop
    {
        protected override void Seed(MembershipContext context)
        {
            ...
            {
                new
                Member{FirstName="Vlado",LastName="Kopić",MembershipDate=DateTime.Parse("2013-12-05"),MemberType=MemberType.DM},
                new
                Member{FirstName="Marin",LastName="Radoš",MembershipDate=DateTime.Parse("2013-02-23"),MemberType=MemberType.DM},
                new
                Member{FirstName="Denis",LastName="Milošević",MembershipDate=DateTime.Parse("2014-04-01"),MemberType=MemberType.PC},
                new
                ...
                new
                Member{FirstName="Dinko",LastName="Tarakčija",MembershipDate=DateTime.Parse("2015-12-12"),MemberType=MemberType.PC}
                };
