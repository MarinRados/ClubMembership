namespace ClubMembership.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ClubMembership.DAL.MembershipContext>
    {
        ...
        protected override void Seed(ClubMembership.DAL.MembershipContext context)
        {
            ...
            {
                new
                Member{FirstName="Vlado",LastName="Kopiæ",MembershipDate=DateTime.Parse("2013-12-05"),MemberType=MemberType.DM},
                new
                Member{FirstName="Marin",LastName="Radoš",MembershipDate=DateTime.Parse("2013-02-23"),MemberType=MemberType.DM},
                new
                Member{FirstName="Denis",LastName="Miloševiæ",MembershipDate=DateTime.Parse("2014-04-01"),MemberType=MemberType.PC},
                new
                Member{FirstName="Michael",LastName="Tilhof",MembershipDate=DateTime.Parse("2014-08-11"),MemberType=MemberType.PC},
                new
                Member{FirstName="Bruno",LastName="Brekalo",MembershipDate=DateTime.Parse("2015-11-12"),MemberType=MemberType.PC},
                new
                Member{FirstName="Dinko",LastName="Tarakèija",MembershipDate=DateTime.Parse("2015-12-12"),MemberType=MemberType.PC}
                };
